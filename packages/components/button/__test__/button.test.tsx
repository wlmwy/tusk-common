...
import type { ButtonType, ButtonSize } from '../src/button';
...
describe("Button.vue", () => {
  ...
  it("should has the correct type class when type prop is set", () => {
    ...
    types.forEach((type) => {
      ...
      expect(wrapper.classes()).toContain(`tk-button--${type}`);
    });
  });
  ...
  it("should has the correct size class when size prop is set", () => {
    ...
    sizes.forEach((size) => {
      ...
      expect(wrapper.classes()).toContain(`tk-button--${size}`);
    });
  });
  ...
  test("basic button", async () => {
    ...
    // class
    expect(wrapper.classes()).toContain("tk-button--primary");
